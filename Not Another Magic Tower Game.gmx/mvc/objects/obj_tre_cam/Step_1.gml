...
if !surface_exists(surf_new_screen)
    surf_new_screen = surface_create(view_wview[0], view_hview[0]);
...
if !surface_exists(surf_new_screen)
    surf_new_screen = surface_create(__view_get( e__VW.WView, 0 ), __view_get( e__VW.HView, 0 ));


if (surface_exists(surfScreen))
{
    surface_set_target(surf_new_screen);
}
else
{
