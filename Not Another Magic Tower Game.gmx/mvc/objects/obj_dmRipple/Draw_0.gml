draw_set_alpha(1);
if (obj_dmRippleController.redrawn) 
{ 
    ...
    tex = surface_get_texture(obj_dmRippleController.buffer_surface);
    tex_x = texture_get_width(tex)/surface_get_width(obj_dmRippleController.buffer_surface);
    tex_y = texture_get_height(tex)/surface_get_height(obj_dmRippleController.buffer_surface);
