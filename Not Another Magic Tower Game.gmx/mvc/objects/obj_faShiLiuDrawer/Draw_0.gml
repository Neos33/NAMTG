...
{
    draw_text(__view_get( e__VW.XView, 0 ) + __view_get( e__VW.WView, 0 ) - 64, yview + 64 * sign(__view_get( e__VW.HView, 0 )), string_hash_to_newline(""));
}
else
{
    draw_text(__view_get( e__VW.XView, 0 ) + __view_get( e__VW.WView, 0 ) - 64, yview + 64 * sign(__view_get( e__VW.HView, 0 )), string_hash_to_newline(obj_monsterBattlePrototype.name));
}


draw_set_halign(fa_left)
draw_text(__view_get( e__VW.XView, 0 ) + 64, yview + 64 * sign(__view_get( e__VW.HView, 0 )), string_hash_to_newline("Kid"));
